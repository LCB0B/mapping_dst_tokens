...
| `token_occurrences.csv` | Per-token prevalence: `token, token_id, n_occurrences, n_people, pct_people` (41,404 tokens) | Source for the prevalence columns in MASTER/MAPPINGS (joined by `code`); see `scripts/oneoff/add_prevalence.py` |
